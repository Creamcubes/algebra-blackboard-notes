...
覆盖北大《高等代数》第五版第二章《行列式》§1—§8及第三章《线性方程组》§1—§7、第四章《矩阵》§1—§7及第五章《二次型》§1—§3，包含已覆盖范围内的星号节。以正文定义、定理、性质、推论及证明为主，不含章后习题。具体范围见 [正文覆盖记录](content/COVERAGE.md)。
...
讲稿参考北大《高等代数》第五版第二章第33—64页、第三章第70—103页、第四章第109—132页及第五章第138—152页，使用英文说明和数学推导。仓库不包含教材 PDF 或扫描页。

当前进度：第五章§1—§3的核心正文，包括二次型与矩阵表示、标准形、复与实规范形、惯性定理的完整反证法、惯性指数与符号差及对称矩阵规范形。下一起点为第五章§4正定二次型（第152页），续写前核对实际进度。网页保持连续章节，不按讲次划分。
