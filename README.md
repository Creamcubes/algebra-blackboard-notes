...
讲稿参考北大《高等代数》第五版第二章第33—64页、第三章第70—103页及第四章第109—125页，使用英文说明和数学推导。仓库不包含教材 PDF 或扫描页。

当前进度：第四章§1—§5（第109—125页），包括矩阵运算、乘积行列式与秩、矩阵的逆及矩阵分块。网页保持连续章节，不按讲次划分。下一起点为§6初等矩阵，第125页。
