...
覆盖北大《高等代数》第五版第二章《行列式》§1—§8及第三章《线性方程组》§1—§7、第四章《矩阵》§1—§7及第五章《二次型》§1—§4，包含已覆盖范围内的星号节。以正文定义、定理、性质、推论及证明为主，不含章后习题。具体范围见 [正文覆盖记录](content/COVERAGE.md)。
...
讲稿参考北大《高等代数》第五版第二章第33—64页、第三章第70—103页、第四章第109—132页及第五章第138—156页，使用英文说明和数学推导。仓库不包含教材 PDF 或扫描页。

当前进度：第五章§1—§4正文已覆盖，包括正定性、顺序主子式判别、其他定性及半正定的五个等价条件。定理8的教材留练证明已作为补充证明加入；章后习题不纳入。下一起点为第六章，续写前核对教材目录及实际进度。网页保持连续章节，不按讲次划分。
